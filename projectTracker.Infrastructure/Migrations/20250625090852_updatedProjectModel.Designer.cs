...
namespace projectTracker.Infrastructure.Migrations
{
    ...
    [Migration("20250625090852_updatedProjectModel")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("projectTracker.Domain.Aggregates.Project", b =>
                {
                    ...
                    b.Property<int>("OverallProjectStatus")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("projectTracker.Domain.Entities.Milestone", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("projectTracker.Domain.Entities.Risk", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("projectTracker.Domain.Aggregates.Project", b =>
                {
                    ...
                    b.OwnsOne("projectTracker.Domain.ValueObjects.ProjectOwner", "Owner", b1 =>
                        {
                            b1.Property<string>("ProjectId")
                                .HasColumnType("nvarchar(450)");
