...
{
    /// <inheritdoc />
    public partial class AddedIdentityForUserManagment : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PrivilageName = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RolePrivileges", x => new { x.RoleId, x.PrivilageId });
                    table.ForeignKey(
                        name: "FK_RolePrivileges_Privileges_PrivilageId",
                        column: x => x.PrivilageId,
                        principalTable: "Privileges",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RolePrivileges_UserRoles_RoleId",
                        column: x => x.RoleId,
